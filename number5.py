...
class Philosopher(threading.Thread):
    def __init__(self, pid, sticks, stomachCapacity=4):
    ...
    def run_odd(self):
        ...
        if self.sticks[i1].acquire(False):
            ...
            if self.sticks[i2].acquire(False):
                ...
                print(
                    "Philosopher " + str(self.pid) + " has failed to get the second stick and released the left stick")
...
for pid in range(numPhilosophers):
    philosophers.append(Philosopher(pid, sticks, 3))
